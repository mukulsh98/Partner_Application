...
//    private Button addMoney, proceed;
    ...
    private TextView partnerBalanceTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        partnerId = sharedPreferences.getString("partnerId","+917587524626"); //TODO to be replaced by firebase id of the user obtained after firebase authentication
        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if (e != null) {
                    ...
                    Toast.makeText(Wallet.this, "Unknown Error", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                partnerBalanceTextView.setText("\u20B9 " + currentAmount);
            }
        });
//
//
...
//                    Toast.makeText(Wallet.this, "Please enter valid amount", Toast.LENGTH_SHORT).show();
//                else {
...
//        Toast.makeText(Wallet.this, "Money added to your wallet", Toast.LENGTH_SHORT).show();
...
//        addAmountDialog = findViewById(R.id.add_amount_dialog);
        partnerBalanceTextView = findViewById(R.id.partner_balance);
    }
//
...
//                    @Override
//                    public void onComplete(@NonNull Task<Void> task) {
//                        Toast.makeText(Wallet.this, "Money added successfully", Toast.LENGTH_SHORT).show();
//                        post.dismiss();
//                    }
//                });
//    }
